...
def train_one_class_svm(X_train, X_val, seed, memory_limit_bytes):

    print(f"Training One-Class SVM (seed {seed})...")
...
def run_seed_experiment(benign_df, seed, memory_limit_bytes):
    ...
    model, threshold, training_metrics = train_one_class_svm(X_train_norm, X_val_norm, seed, memory_limit_bytes)
